...
import { ChevronRight, Folder, GripVertical, Pencil, Trash2 } from "lucide-react";
      ...
      <ContextMenu>
        <ContextMenuTrigger>
          <SidebarGroupLabel
            ref={setDroppableRef}
            className={cn(
              "cursor-pointer select-none hover:bg-sidebar-accent/50 rounded-md transition-colors overflow-hidden",
